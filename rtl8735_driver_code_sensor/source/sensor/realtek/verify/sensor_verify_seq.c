...
#define SENSOR_WIDTH (4016/2 + 24)//(2016 + 16) // x_overlap
#define SENSOR_HEIGHT (3008/2 + 24)//3024
#define SENSOR_HTS 2400//1000
#define SENSOR_VTS 3200//1200
#define SENSOR_FPS 6
...
static int __config_regs(struct verify_status *status)
{
	...
	// bit-16: drc_keep_en. 67e: original IQ table. Note: bit-15: drc_update_en should be 0.
	const uint32_t drc_ctrl = isp_read_reg(0x1c78) | 0x10000;
 
	isp_write_reg(drc_ctrl, 0x1c78);
	printf("[INFO][__config_regs] DRC: 0x%x\r\n", isp_read_reg(0x1c78));
