...
static struct gc4653_status g_status[SUPPORTED_ISP_NUM] = {[0].hdr = LINEAR_MODE};
...
static struct rts_isp_i2c_reg g_gc4653_i2c_init_regs[] = {
	/****************************************/
	//framelength 1500
	//rowtime 44.44us  // 15fps
	//rowtime 26.67us  // 20fps
    //rowtime 22.22us  // 30fps
	//pattern grbg
	{0x03fe,0xf0},
	{0x03fe,0x00},
	{0x0317,0x00},
...
static int gc4653_set_mirror_flip(uint32_t isp_id,
...
static int gc4653_get_slave_addr_num(uint32_t isp_id)
{
...
static const struct rts_isp_sensor_ops gc4653_ops = {
	...
	.set_mirror_flip = gc4653_set_mirror_flip,
	.check = gc4653_check,
	.get_slave_addr_num = gc4653_get_slave_addr_num,
};
