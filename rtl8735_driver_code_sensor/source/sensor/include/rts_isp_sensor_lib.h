...
#include <stdint.h>
#include <rts_camera_isp_snr_lib.h>
#include <rts_isp_errno_lib.h>
#include <rts_isp_geom_lib.h>
...
#define _FIXP_SENSOR_				DISABLE
#define _FIXP2K_SENSOR_				DISABLE
#define _FIXP5M_SENSOR_				DISABLE
#define _FIXP4M169_SENSOR_			DISABLE
#define _PSEUDO_5M_SENSOR_			DISABLE
#define _PSEUDO_2M_SENSOR_			DISABLE
#define _VERIFY_SEQ_SENSOR_			DISABLE
#define _VERIFY_STILL_SENSOR_		DISABLE
#define _GC2053_SENSOR_				DISABLE
#define _GC2083_SENSOR_				DISABLE
#define _GC4023_SENSOR_				DISABLE
#define _SC2310_SENSOR_				DISABLE
#define _RS0551C_SENSOR_			DISABLE
#define _RS0551C2K_SENSOR_			DISABLE
#define _RS0551C4M_SENSOR_			DISABLE
#define _RS0551C60FPS_SENSOR_		DISABLE
#define _GC4653_SENSOR_				DISABLE
#define _PS5258_SENSOR_				DISABLE
#define _PS5270_SENSOR_				DISABLE
#define _IMX307_SENSOR_				DISABLE
#define _IMX307HDR_SENSOR_			DISABLE
#define _RS0551CFT2_SENSOR_			DISABLE
#define _RS0551C1360X768_SENSOR_	DISABLE
#define _RS0551CYUV_SENSOR_			DISABLE
#define _K05_SENSOR_				DISABLE
#define _SC2336_SENSOR_				DISABLE
#define _MIS2008_SENSOR_			DISABLE
#define _IMX327_SENSOR_				DISABLE
#define _IMX681_SENSOR_				DISABLE
#define _IMX681_12M_SENSOR_			DISABLE
#define _IMX681_12M_SEQ_SENSOR_		DISABLE
#define _IMX471_SENSOR_				DISABLE
#define _F37_SENSOR_				DISABLE
#define _SC301_SENSOR_				DISABLE
#define _GC4663_SENSOR_				DISABLE
#define _OV13B10_SENSOR_			DISABLE
#define _OV13B10_12M_SENSOR_		DISABLE
#define _OV13B10_12M_SEQ_SENSOR_	DISABLE
#define _OV12890_SENSOR_			DISABLE
#define _OV12890_12M_SENSOR_		DISABLE
#define _OV12890_12M_SEQ_SENSOR_	DISABLE
...
struct rts_isp_sensor_ops {
	...
	/* when entered short_exp_mode, we will disable TNR to use lower exposure time */
...
#define rts_isp_sensor_access_prepare() 	voe_ops->ops.rts_isp_sensor_access_prepare()
#define rts_isp_sensor_access_unprepare() 	voe_ops->ops.rts_isp_sensor_access_unprepare()
#define rts_isp_read_sensor_reg(a, b) 		voe_ops->ops.rts_isp_read_sensor_reg(a, b)
#define rts_isp_write_sensor_reg(a, b) 		voe_ops->ops.rts_isp_write_sensor_reg(a, b)
#define rts_isp_read_i2c_regs(a, b)			voe_ops->ops.rts_isp_read_i2c_regs(a, b)
#define rts_isp_write_i2c_regs(a, b)		voe_ops->ops.rts_isp_write_i2c_regs(a, b)
#define rts_isp_read_i2c_reg(a, b)			voe_ops->ops.rts_isp_read_i2c_reg(a, b)
#define rts_isp_write_i2c_reg(a, b)			voe_ops->ops.rts_isp_write_i2c_reg(a, b)
#define printf(fmt, arg...)					voe_ops->ops.printf(fmt, ##arg)
#define rts_isp_sensor_get_open_mode()		voe_ops->ops.rts_isp_sensor_get_open_mode()
#define rts_isp_sensor_get_close_mode()		voe_ops->ops.rts_isp_sensor_get_close_mode()
	// hal_timer.h
#define hal_delay_us(us)					voe_ops->ops.hal_delay_us(us)
	// isp_driver.h
#define isp_driver_mem_alloc(phy_addr, length, info)	voe_ops->ops.isp_driver_mem_alloc(phy_addr, length, info)
#define isp_driver_mem_free(phy_addr) 					voe_ops->ops.isp_driver_mem_free(phy_addr)
#define isp_driver_mmap(start, size) 					voe_ops->ops.isp_driver_mmap(start, size)
#define hal_isp_get_verify_info(a)						voe_ops->ops.hal_isp_get_verify_info(a)
#define sensor_get_slave_addr_idx()						voe_ops->ops.sensor_get_slave_addr_idx()
#ifdef __cplusplus
}
#endif
