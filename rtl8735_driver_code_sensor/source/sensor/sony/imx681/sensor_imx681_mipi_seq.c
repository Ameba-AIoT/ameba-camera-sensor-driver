...
#define SENSOR_WIDTH 2128
#define SENSOR_HEIGHT 1604
...
static int __config_regs(struct verify_status *status)
{
	...
	printf("[INFO][sensor_imx681_mipi_12m_seq][__config_regs] (org) DRC: 0x%x, drc_en: %d\r\n",
		drc_ctrl_org, drc_en_org);
	printf("[INFO][sensor_imx681_mipi_12m_seq][__config_regs] (new) DRC: 0x%x, drc_en: %d\r\n",
