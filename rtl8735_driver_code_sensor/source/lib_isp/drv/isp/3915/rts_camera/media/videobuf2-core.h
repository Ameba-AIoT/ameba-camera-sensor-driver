 ...
 */
struct vb2_mem_ops {
	void		*(*alloc)(unsigned long attrs,
				  unsigned long size,
...
//	gfp_t				gfp_flags;
	...
	xQueueHandle		done_list;
	osMutexId_t			done_lock;
//	xQueueHandle		done_wq;
