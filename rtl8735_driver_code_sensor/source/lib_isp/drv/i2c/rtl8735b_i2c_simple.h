...
hal_status_t hal_rtl_i2c_send_addr_retry_simple (volatile hal_i2c_adapter_t *phal_i2c_adapter);
hal_status_t hal_rtl_i2c_send_poll_simple (volatile hal_i2c_adapter_t *phal_i2c_adapter);
hal_status_t hal_rtl_i2c_recv_addr_retry_simple (volatile hal_i2c_adapter_t *phal_i2c_adapter);
