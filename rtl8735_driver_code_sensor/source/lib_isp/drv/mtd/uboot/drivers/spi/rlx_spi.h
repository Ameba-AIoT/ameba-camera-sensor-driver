...
/*                                                      */
	struct {
		...
		volatile uint32_t nop_nop[5];
		volatile uint32_t rst_fifo;	/*programmable reset flow Reg	(0x140)*/
	};
};
...
#define bfoSPI_FLASH_RISR_ACSIR				((uint32_t)		11)
...
#define BRADR_SICHAL_RX_HS	0Xffc0ffff
#define OVER_MAX_DATA_FRAME	0X00010000
#define DR_DATA_BYTE		0x000000ff
#define DR_DATA_HALF		0x0000ffff
#define RDSR_CMD			0x05
#define WREN_CMD			0x06
#define BUSY_FLAG			0x1
#define WRDI_CMD			0x04
#define RDID_CMD			0x9f
#define BRADR_SICHAL_TX_HS	0xffc0fcff
#define RX_MODE				0x00000300
#define DA_AD_QUAD			0x000a0000
#define DA_QUAD_AD_SI		0x00080000
#define DA_AD_DUAL			0x00050000
#define DA_DUAL_AD_SI		0x00040000
#define SPIC_DISABLE		0xfffffffe
#define AUTO_CHECK_INT_EN	0x00000800
#define TIME_OUT_VALUE_H	0x02000000
#define TIME_OUT_VALUE_L	0xff7fffff
#define PRM_MODE_EN			0x800
#define PRM_MODE_DIS		0xfffff7ff
#define PRM_VALUE_CLR		0x00ffff
#define PRM_VALUE_VA		0xA50000
#define CTRLR0_CH_FRD_SI_EN	0x1001
