...
#define SYSBASE_REG(x)			((void *)(x) + SYSBASE_VA)
...
#define XB2_UART0_PULL_UP_CTRL XB2BASE_REG(0x30)
#define UART0_TX_PE_SHIFT	0
#define UART0_TX_PE_MASK	3
#define UART0_RX_PE_SHIFT	2
#define UART0_RX_PE_MASK	0xc
#define UART0_PE_PU	0x2
#define UART0_PE_PD	0x1

#define XB2_UART1_PULL_UP_CTRL XB2BASE_REG(0x3c)
#define UART1_TX_PE_SHIFT	0
#define UART1_TX_PE_MASK	3
#define UART1_RX_PE_SHIFT	2
#define UART1_RX_PE_MASK	0xc
#define UART1_PE_PU	0x2
#define UART1_PE_PD	0x1

#define XB2_UART2_PULL_UP_CTRL XB2BASE_REG(0x48)
#define UART2_TX_PE_SHIFT	0
#define UART2_TX_PE_MASK	3
#define UART2_RX_PE_SHIFT	2
#define UART2_RX_PE_MASK	0xc
#define UART2_PE_PU	0x2
#define UART2_PE_PD	0x1
...
#define GPIO_UART2_TXD (1 << 4)
#define GPIO_UART2_RXD (1 << 5)
#define GPIO_UART1_TXD (1 << 6)
#define GPIO_UART1_RXD (1 << 7)
#define GPIO_UART0_TXD (1 << 8)
#define GPIO_UART0_RXD (1 << 9)
...
//#define UART_BASE(x)	((x) * 0x0100)
//#define U_MODE(x)	UART_BASE(x)

/* Register offset from UARTx_IOBASE */
#define RTS_UART_RBR		0x00
#define RTS_UART_THR		0x00
#define RTS_UART_IER		0x04
#define RTS_UART_IIR		0x08
#define RTS_UART_LCR		0x0C
#define RTS_UART_LSR		0x14
#define RTS_UART_DLL		0x00
#define RTS_UART_DLH		0x04
#define RTS_UART_CTR		0xFC
