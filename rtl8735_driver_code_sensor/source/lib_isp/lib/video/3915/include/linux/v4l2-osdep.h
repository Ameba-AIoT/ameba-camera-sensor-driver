...
#define _atomic_spin_lock_irqsave(p, flags)			save_and_cli(flags)
#endif
#ifndef _atomic_spin_unlock_irqrestore
#define _atomic_spin_unlock_irqrestore(p, flags)	restore_flags(flags)
#endif
...
#endif
#ifndef atomic_sub
	#define atomic_sub(v, i)		((v)->counter -= (i))
#endif
#ifndef atomic_inc
 ...
 */
#ifndef _IOCTL_IO
#define _IOCTL_IO(type, nr)			_IOC(_IOC_NONE, (type), (nr), 0)
#endif
#ifndef _IOCTL_IOR
#define _IOCTL_IOR(type, nr, size)	_IOC(_IOC_READ, (type), (nr), sizeof(size))
#endif
#ifndef _IOCTL_IOW
#define _IOCTL_IOW(type, nr, size)	_IOC(_IOC_WRITE, (type), (nr), sizeof(size))
#endif
#ifndef _IOCTL_IOWR
#define _IOCTL_IOWR(type, nr, size)	_IOC(_IOC_READ|_IOC_WRITE, (type), (nr), sizeof(size))
#endif
/*
