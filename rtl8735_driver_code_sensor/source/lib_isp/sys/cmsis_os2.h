...
//replace freerto_service.h start
...
typedef osSemaphoreId osSemaphoreId_t;
/// \details Mutex ID identifies the mutex.
typedef _mutex osMutexId_t;
...
#define osErrorTimeout osEventTimeout
#define osStatusReserved os_status_reserved
