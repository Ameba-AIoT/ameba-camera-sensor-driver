...
struct rts_av_osdenc_attr {
	int chn_id;  //struct rts_av_obj obj;
	__attribute__((aligned(32)))  struct rts_video_osd2_attr attr;
...
int rts_osd2_init(int chn_id, int buf_id, RtsOsd2Inst *posd, struct rts_osd2_config *config);
