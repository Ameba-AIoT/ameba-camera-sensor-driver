...
#include <platform_conf.h>  //for profiling tool

#ifndef __NVIC_PRIO_BITS
#define __NVIC_PRIO_BITS               4        /*!< Number of Bits used for Priority Levels for rtl8735b            */
#endif
...
#define configCPU_CLOCK_HZ						( CONFIG_VOE_CLK )
...
#if CONFIG_VERIFY_SYSVIEW	//define in  verify_conf.h
#include <SEGGER_SYSVIEW_FreeRTOS.h>
#define CONFIG_RTOS_TRACE_PATCH 1   //apply rtos patch code for profiling tool.
#endif
