						...
						TaskHandle_t * const pxCreatedTask ) /*lint !e971 Unqualified char types are allowed for strings and single characters only. */
{
	...
	if(wrapper)
	#else
    typedef TaskHandle_t __attribute__((cmse_nonsecure_call)) (*wrapper_t)( uint32_t ulTaskId, uint16_t usSecureStackDepth, UBaseType_t uxPriority);
    wrapper_t wrapper;
    
	wrapper = (wrapper_t)cmse_nsfptr_create(rtos_ns.taskCreate);
	...
	#endif
	{
		...
		if(createdTask){
			...
			#if defined(SET_NS_NAME) && (SET_NS_NAME != 0)
...
void vTaskDelete( TaskHandle_t xTaskToDelete )
{
	...
	if(wrapper)
	#else
	typedef void __attribute__((cmse_nonsecure_call)) (*wrapper_t)( TaskHandle_t xTaskToDelete );
    wrapper_t wrapper;
    
	wrapper = (wrapper_t)cmse_nsfptr_create(rtos_ns.taskDelete);
	if (wrapper && cmse_is_nsfptr(wrapper)) 
	#endif
	{
...
void vTaskDelay(TickType_t xTicksToDelay)
{
	...
	if(wrapper)
	#else	
	typedef void __attribute__((cmse_nonsecure_call)) (*wrapper_t)(TickType_t xTicksToDelay);
    wrapper_t wrapper;
    
	wrapper = (wrapper_t)cmse_nsfptr_create(rtos_ns.taskDelay);
	if (wrapper && cmse_is_nsfptr(wrapper)) 
	#endif
	{
...
void vTaskSuspend( TaskHandle_t xTaskToSuspend ) 
{
	...
	if(wrapper)
	#else		
	typedef void __attribute__((cmse_nonsecure_call)) (*wrapper_t)(TaskHandle_t xTaskToSuspend);
    wrapper_t wrapper;
    
	wrapper = (wrapper_t)cmse_nsfptr_create(rtos_ns.taskSuspend);
	if (wrapper && cmse_is_nsfptr(wrapper)) 
	#endif
	{
...
void vTaskResume( TaskHandle_t xTaskToResume )
{
	...
	if(wrapper)
	#else	
	typedef void __attribute__((cmse_nonsecure_call)) (*wrapper_t)(TaskHandle_t xTaskToResume);
    wrapper_t wrapper;
    
	wrapper = (wrapper_t)cmse_nsfptr_create(rtos_ns.taskResume);
	if (wrapper && cmse_is_nsfptr(wrapper)) 
	#endif
	{
...
void vTaskSuspendAll( void ) 
{
	...
	if(wrapper)
	#else	
	typedef void __attribute__((cmse_nonsecure_call)) (*wrapper_t)(void);
    wrapper_t wrapper;
    
	wrapper = (wrapper_t)cmse_nsfptr_create(rtos_ns.taskSuspendAll);
	if (wrapper && cmse_is_nsfptr(wrapper)) 
	#endif
	{
		wrapper();
...
BaseType_t xTaskResumeAll( void ) 
{
	...
	if(wrapper)
	#else	
	typedef BaseType_t __attribute__((cmse_nonsecure_call)) (*wrapper_t)(void);
    wrapper_t wrapper;
    
	wrapper = (wrapper_t)cmse_nsfptr_create(rtos_ns.taskResumeAll);
	if (wrapper && cmse_is_nsfptr(wrapper)) 
	#endif
	{
		return wrapper();
...
TickType_t xTaskGetTickCount( void ) 
{
	...
	if(wrapper)
	#else		
	typedef TickType_t __attribute__((cmse_nonsecure_call)) (*wrapper_t)(void);
    wrapper_t wrapper;
    
	wrapper = (wrapper_t)cmse_nsfptr_create(rtos_ns.taskGetTickCount);
	if (wrapper && cmse_is_nsfptr(wrapper)) 
	#endif
	{
		return wrapper();
...
TaskHandle_t xTaskGetCurrentTaskHandle( void )
{
	...
	if(wrapper)
	#else		
	typedef TaskHandle_t __attribute__((cmse_nonsecure_call)) (*wrapper_t)(void);
    wrapper_t wrapper;
    
	wrapper = (wrapper_t)cmse_nsfptr_create(rtos_ns.taskGetCurrentTaskHandle);
	if (wrapper && cmse_is_nsfptr(wrapper)) 
	#endif
	{
		return wrapper();
...
char* pcTaskGetName( TaskHandle_t xTaskToQuery )
{
	...
	if(wrapper)
	#else		
	typedef char* __attribute__((cmse_nonsecure_call)) (*wrapper_t)(TaskHandle_t xTaskToQuery);
    wrapper_t wrapper;
    
	wrapper = (wrapper_t)cmse_nsfptr_create(rtos_ns.taskGetName);
	if (wrapper && cmse_is_nsfptr(wrapper)) 
	#endif
	{
		char *str = wrapper(xTaskToQuery);
		#if defined (SET_NS_NAME) && (!SET_NS_NAME)
...
void *pvPortMallocNS( size_t xWantedSize )
{
	...
	if(wrapper)
	#else			
	typedef void * __attribute__((cmse_nonsecure_call)) (*wrapper_t)( size_t xWantedSize );
    wrapper_t wrapper;
    
	wrapper = (wrapper_t)cmse_nsfptr_create(rtos_ns.portMalloc);
	if (wrapper && cmse_is_nsfptr(wrapper)) 
	#endif
	{
...
void vPortFreeNS( void *pv )
{
	...
	if(wrapper)
	#else		
	typedef void __attribute__((cmse_nonsecure_call)) (*wrapper_t)( void *pv );
    wrapper_t wrapper;
    
	wrapper = (wrapper_t)cmse_nsfptr_create(rtos_ns.portFree);
	if (wrapper && cmse_is_nsfptr(wrapper)) 
	#endif
	{
		// check pv on ns-mem?
...
TimerHandle_t xTimerCreate( const char * const pcTimerName, const TickType_t xTimerPeriodInTicks, const UBaseType_t uxAutoReload, void * const pvTimerID, TimerCallbackFunction_t pxCallbackFunction )
{
	...
	if(wrapper)
	#else		
	typedef TimerHandle_t __attribute__((cmse_nonsecure_call)) (*wrapper_t)( TickType_t xTimerPeriodInTicks, UBaseType_t uxAutoReload, void * pvTimerID, TimerCallbackFunction_t pxCallbackFunction );
    wrapper_t wrapper;
    
	wrapper = (wrapper_t)cmse_nsfptr_create(rtos_ns.timerCreate);
	if (wrapper && cmse_is_nsfptr(wrapper)) 
	#endif
	{
		TimerHandle_t tmp =  wrapper(xTimerPeriodInTicks, uxAutoReload, pvTimerID, pxCallbackFunction);
		#if defined(NS_SET_NAME) && (NS_SET_NAME != 0)
...
BaseType_t xTimerIsTimerActive( TimerHandle_t xTimer )
{
	...
	if(wrapper)
	#else		
	typedef BaseType_t __attribute__((cmse_nonsecure_call)) (*wrapper_t)( TimerHandle_t xTimer );
    wrapper_t wrapper;
    
	wrapper = (wrapper_t)cmse_nsfptr_create(rtos_ns.timerIsTimerActive);
	if (wrapper && cmse_is_nsfptr(wrapper)) 
	#endif
	{
...
TickType_t xTimerGetPeriod( TimerHandle_t xTimer )
{
	...
	if(wrapper)
	#else	
	typedef TickType_t __attribute__((cmse_nonsecure_call)) (*wrapper_t)( TimerHandle_t xTimer );
    wrapper_t wrapper;
    
	wrapper = (wrapper_t)cmse_nsfptr_create(rtos_ns.timerGetPeriod);
	if (wrapper && cmse_is_nsfptr(wrapper)) 
	#endif
	{
		return wrapper(xTimer);
...
TickType_t xTimerGetExpiryTime( TimerHandle_t xTimer )
{
	...
	wrapper = (wrapper_t)cmse_nsfptr_create(rtos_ns.timerGetExpiryTime);
	if (wrapper && cmse_is_nsfptr(wrapper)) 
	#endif
	{
		return wrapper(xTimer);
...
const char * pcTimerGetName( TimerHandle_t xTimer )
{
	...
	if(wrapper)
	#else			
	typedef const char * __attribute__((cmse_nonsecure_call)) (*wrapper_t)( TimerHandle_t xTimer );
    wrapper_t wrapper;
    
	wrapper = (wrapper_t)cmse_nsfptr_create(rtos_ns.timerGetName);
	if (wrapper && cmse_is_nsfptr(wrapper)) 
	#endif
	{
		return wrapper(xTimer);
...
BaseType_t xTimerGenericCommand( TimerHandle_t xTimer, const BaseType_t xCommandID, const TickType_t xOptionalValue, BaseType_t * const pxHigherPriorityTaskWoken, const TickType_t xTicksToWait )
{
	...
	if(wrapper)
	#else		
	typedef BaseType_t __attribute__((cmse_nonsecure_call)) (*wrapper_t)( uint32_t * params );
    wrapper_t wrapper;
    
	wrapper = (wrapper_t)cmse_nsfptr_create(rtos_ns.timerGenericCommand);
	if (wrapper && cmse_is_nsfptr(wrapper)) 
	#endif
	{
...
EventGroupHandle_t xEventGroupCreate( void )
{
	...
	if(wrapper)
	#else		
	typedef EventGroupHandle_t __attribute__((cmse_nonsecure_call)) (*wrapper_t)( void );
    wrapper_t wrapper;
    
	wrapper = (wrapper_t)cmse_nsfptr_create(rtos_ns.eventGroupCreate);
	if (wrapper && cmse_is_nsfptr(wrapper)) 
	#endif
	{
		return wrapper();
...
void vEventGroupDelete( EventGroupHandle_t xEventGroup )
{
	...
	if(wrapper)
	#else	
	typedef void __attribute__((cmse_nonsecure_call)) (*wrapper_t)( EventGroupHandle_t xEventGroup );
    wrapper_t wrapper;
    
	wrapper = (wrapper_t)cmse_nsfptr_create(rtos_ns.eventGroupDelete);
	if (wrapper && cmse_is_nsfptr(wrapper)) 
	#endif
	{
		wrapper(xEventGroup);
...
EventBits_t xEventGroupWaitBits( EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToWaitFor, const BaseType_t xClearOnExit, const BaseType_t xWaitForAllBits, TickType_t xTicksToWait )
{
	...
	if(wrapper)
	#else		
	typedef EventBits_t __attribute__((cmse_nonsecure_call)) (*wrapper_t)( uint32_t * params );
    wrapper_t wrapper;
    
	wrapper = (wrapper_t)cmse_nsfptr_create(rtos_ns.eventGroupWaitBits);
	if (wrapper && cmse_is_nsfptr(wrapper)) 
	#endif
	{
		uint32_t *params = pvPortMallocNS(sizeof(uint32_t)*8);
...
EventBits_t xEventGroupSetBits( EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToSet )
{
	...
	if(wrapper)
	#else			
	typedef EventBits_t __attribute__((cmse_nonsecure_call)) (*wrapper_t)( EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToSet );
    wrapper_t wrapper;
    
	wrapper = (wrapper_t)cmse_nsfptr_create(rtos_ns.eventGroupSetBits);
	if (wrapper && cmse_is_nsfptr(wrapper)) 
	#endif
	{
...
EventBits_t xEventGroupClearBits( EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToClear )
{
	...
	if(wrapper)
	#else		
	typedef EventBits_t __attribute__((cmse_nonsecure_call)) (*wrapper_t)( EventGroupHandle_t xEventGroup, EventBits_t uxBitsToClear );
    wrapper_t wrapper;
    
	wrapper = (wrapper_t)cmse_nsfptr_create(rtos_ns.eventGroupClearBits);
	if (wrapper && cmse_is_nsfptr(wrapper)) 
	#endif
	{
...
EventBits_t xEventGroupSync( EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToSet, const EventBits_t uxBitsToWaitFor, TickType_t xTicksToWait )
{
	...
	if(wrapper)
	#else			
	typedef EventBits_t __attribute__((cmse_nonsecure_call)) (*wrapper_t)( EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToSet, const EventBits_t uxBitsToWaitFor, TickType_t xTicksToWait );
    wrapper_t wrapper;
    
	wrapper = (wrapper_t)cmse_nsfptr_create(rtos_ns.eventGroupSync);
	if (wrapper && cmse_is_nsfptr(wrapper)) 
	#endif
	{
...
size_t xPortGetFreeHeapSizeNS( void )
{
	...
	if(wrapper)
	#else		
	typedef size_t __attribute__((cmse_nonsecure_call)) (*wrapper_t)( void );
    wrapper_t wrapper;
    
	wrapper = (wrapper_t)cmse_nsfptr_create(rtos_ns.portGetFreeHeapSize);
	if (wrapper && cmse_is_nsfptr(wrapper)) 
	#endif
	{
		return wrapper();
...
QueueHandle_t xQueueGenericCreate( const UBaseType_t uxQueueLength, const UBaseType_t uxItemSize, const uint8_t ucQueueType )
{
	...
	if(wrapper)
	#else		
	typedef QueueHandle_t __attribute__((cmse_nonsecure_call)) (*wrapper_t)(UBaseType_t uxQueueLength, UBaseType_t uxItemSize, uint8_t ucQueueType);
    wrapper_t wrapper;
    
	wrapper = (wrapper_t)cmse_nsfptr_create(rtos_ns.queueGenericCreate);
	if (wrapper && cmse_is_nsfptr(wrapper)) 
	#endif
	{
...
BaseType_t xQueueReceive( QueueHandle_t xQueue, void * const pvBuffer, TickType_t xTicksToWait)
{
	...
	if(wrapper)
	#else	
	typedef BaseType_t __attribute__((cmse_nonsecure_call)) (*wrapper_t)(QueueHandle_t xQueue, void * pvBuffer, TickType_t xTicksToWait);
    wrapper_t wrapper;
    
	wrapper = (wrapper_t)cmse_nsfptr_create(rtos_ns.queueReceive);
	if (wrapper && cmse_is_nsfptr(wrapper)) 
	#endif
	{
...
BaseType_t xQueuePeek( QueueHandle_t xQueue, void * const pvBuffer, TickType_t xTicksToWait )
{
	...
	wrapper = (wrapper_t)cmse_nsfptr_create(rtos_ns.queuePeek);
	if (wrapper && cmse_is_nsfptr(wrapper)) 
	#endif
	{
		return wrapper(xQueue, pvBuffer, xTicksToWait);
...
BaseType_t xQueueSemaphoreTake( QueueHandle_t xQueue, TickType_t xTicksToWait )
{
	...
	if(wrapper)
	#else	
	typedef BaseType_t __attribute__((cmse_nonsecure_call)) (*wrapper_t)(QueueHandle_t xQueue, TickType_t xTicksToWait);
    wrapper_t wrapper;
    
	wrapper = (wrapper_t)cmse_nsfptr_create(rtos_ns.queueSemaphoreTake);
	if (wrapper && cmse_is_nsfptr(wrapper)) 
	#endif
	{
...
BaseType_t xQueueGenericSend( QueueHandle_t xQueue, const void * const pvItemToQueue, TickType_t xTicksToWait, const BaseType_t xCopyPosition )
{
	...
	if(wrapper)
	#else		
	typedef BaseType_t __attribute__((cmse_nonsecure_call)) (*wrapper_t)(QueueHandle_t xQueue, const void * pvItemToQueue, TickType_t xTicksToWait, BaseType_t xCopyPosition);
    wrapper_t wrapper;
    
	wrapper = (wrapper_t)cmse_nsfptr_create(rtos_ns.queueGenericSend);
	if (wrapper && cmse_is_nsfptr(wrapper)) 
	#endif
	{
...
BaseType_t xQueueGenericReset( QueueHandle_t xQueue, BaseType_t xNewQueue )
{
	...
	if(wrapper)
	#else		
	typedef BaseType_t __attribute__((cmse_nonsecure_call)) (*wrapper_t)(QueueHandle_t xQueue, BaseType_t xNewQueue);
    wrapper_t wrapper;
    
	wrapper = (wrapper_t)cmse_nsfptr_create(rtos_ns.queueGenericReset);
	if (wrapper && cmse_is_nsfptr(wrapper)) 
	#endif
	{
